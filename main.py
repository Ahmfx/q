...
token = "7419159937:AAH6REnj0fYxTef_nnLl_H2B8RYlWNEGFIs" # توكنك
id = "1451542769" # ايديك

def usernames():
    j = ''.join(choice("1234567890") for i in range(1))
    o = ''.join(choice("0123456789") for i in range(1))
    ...
    g = ''.join(choice("0123456789") for i in range(1)) 
